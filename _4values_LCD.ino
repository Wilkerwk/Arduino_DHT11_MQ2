...
const int MQ_PIN=A7;                                //define which analog input channel you are going to use
...
int CALIBRATION_SAMPLE_INTERVAL=100;                //define the time interal(in milisecond) between each samples in the
                                                    //cablibration phase
int READ_SAMPLE_TIMES=10;                        //define how many samples you are going to take in normal operation
int READ_SAMPLE_INTERVAL=20;                            //define the time interal(in milisecond) between each samples in 
                                                    //normal operation
...
{ 
  ...
  lcd.print("Warm up 3 min");                        //LCD display
  lcd.setCursor(0,1);
  lcd.print("before calibr.");
  delay(4000);
  lcd.clear();
...
*/  
  ...
  lcd.setCursor(7,1);
  lcd.print("R=");
  lcd.print(iRs);  /*internal resistence obtained from the voltage reading in analog pin*/
  lcd.print("kohm");
   /*
   lcd.print("Sm:");
